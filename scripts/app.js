...
class FinanceTrackerApp {
    ...
    initializeEventListeners() {
        ...
        document.querySelectorAll('.nav-link').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (view === 'form') {
                    // Only populate categories if the dropdown is empty
    ...
    handleFormSubmit() {
        ...
        if (validation.isValid) {
            ...
            if (validation.warnings.duplicateWords) {
                document.getElementById('advanced-check').textContent = validation.warnings.duplicateWords;
            }
    ...
    handleDescriptionInput(value) {
        ...
        if (result.warning) {
            document.getElementById('advanced-check').textContent = result.warning;
        }
    }
    ...
    initializeRecordsHandlers() {
        ...
        document.getElementById('records-cards-container').addEventListener('click', (e) => {
            this.handleRecordAction(e);
        });
